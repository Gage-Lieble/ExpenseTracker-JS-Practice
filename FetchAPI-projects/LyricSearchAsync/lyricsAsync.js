...
subBtn.addEventListener('click', function(){
    ...
    let fetchData = async (userInput) => { // async sets up function to await other logic
    const options = {
        method: 'GET',
        headers: {
        ...
        try{
            let result = await fetch(`https://genius.p.rapidapi.com/search?q=${userInput}`, options) // fetches data and stores it in 'result'
            let data = await result.json()  // converts 'result' to json and stores it in 'data'
